...
> **And it publishes its error rate. Fifty hand-labelled cases, half of them carve-outs designed to catch a keyword matcher, including five written to find the edge of what static analysis can decide. It passes all fifty — and the report says plainly that this is a statement about the corpus, not about the world.**
...
| 2:12 | `50 cases · 100% tier accuracy · 100% carve-out precision` |
