...
> **And it publishes its error rate. Forty-eight hand-labelled cases, half of them carve-outs designed to catch a keyword matcher, including five written to find the edge of what static analysis can decide. It passes all forty-eight — and the report says plainly that this is a statement about the corpus, not about the world.**
