...
**Stack:** Node 22, TypeScript strict, Next.js 16 / React 19 server components, Tailwind 4, SQLite via `better-sqlite3`, `jose` for sessions, Vitest, Playwright. 126 tests, a 42-case benchmark, CI that typechecks, tests, benchmarks and then runs Annex on Annex.
